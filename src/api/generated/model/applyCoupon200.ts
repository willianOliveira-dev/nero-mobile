 ...
 */
import type { ApplyCoupon200Coupon } from './applyCoupon200Coupon';
import type { ApplyCoupon200ItemsItem } from './applyCoupon200ItemsItem';
import type { ApplyCoupon200Totals } from './applyCoupon200Totals';

export type ApplyCoupon200 = {
  /** @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$ */
  id: string;
  coupon: ApplyCoupon200Coupon;
  items: ApplyCoupon200ItemsItem[];
  totals: ApplyCoupon200Totals;
  updatedAt: string;
};
