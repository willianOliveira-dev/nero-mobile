...
export type CreateReviewBodyMediaItemType = typeof CreateReviewBodyMediaItemType[keyof typeof CreateReviewBodyMediaItemType];


export const CreateReviewBodyMediaItemType = {
  image: 'image',
  video: 'video',
} as const;
