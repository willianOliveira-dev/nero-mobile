 ...
 */
import type { AddCartItem200Coupon } from './addCartItem200Coupon';
import type { AddCartItem200ItemsItem } from './addCartItem200ItemsItem';
import type { AddCartItem200Totals } from './addCartItem200Totals';

export type AddCartItem200 = {
  /** @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$ */
  id: string;
  coupon: AddCartItem200Coupon;
  items: AddCartItem200ItemsItem[];
  totals: AddCartItem200Totals;
  updatedAt: string;
};
