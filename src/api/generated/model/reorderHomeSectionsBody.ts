 ...
 */
import type { ReorderHomeSectionsBodyItemsItem } from './reorderHomeSectionsBodyItemsItem';

export type ReorderHomeSectionsBody = {
  /** @minItems 1 */
  items: ReorderHomeSectionsBodyItemsItem[];
};
