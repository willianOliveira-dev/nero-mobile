...
export type SearchProducts200ItemsItemStatus = typeof SearchProducts200ItemsItemStatus[keyof typeof SearchProducts200ItemsItemStatus];


export const SearchProducts200ItemsItemStatus = {
  draft: 'draft',
  active: 'active',
  archived: 'archived',
} as const;
