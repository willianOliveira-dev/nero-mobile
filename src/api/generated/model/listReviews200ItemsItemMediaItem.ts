 ...
 */
import type { ListReviews200ItemsItemMediaItemType } from './listReviews200ItemsItemMediaItemType';

export type ListReviews200ItemsItemMediaItem = {
  type: ListReviews200ItemsItemMediaItemType;
  url: string;
