 ...
 */
import type { ListAllOrders200DataItemItemsItemProduct } from './listAllOrders200DataItemItemsItemProduct';

export type ListAllOrders200DataItemItemsItem = {
  quantity: number;
  product: ListAllOrders200DataItemItemsItemProduct;
};
