 ...
 */
import type { UpdateHomeSectionBodyFilterJson } from './updateHomeSectionBodyFilterJson';
import type { UpdateHomeSectionBodyType } from './updateHomeSectionBodyType';

export type UpdateHomeSectionBody = {
  /**
   * @minLength 2
   * @maxLength 80
   ...
   */
  title?: string;
  type?: UpdateHomeSectionBodyType;
  /**
   * @minimum 0
  ...
  sortOrder?: number;
  isActive?: boolean;
  filterJson?: UpdateHomeSectionBodyFilterJson;
};
