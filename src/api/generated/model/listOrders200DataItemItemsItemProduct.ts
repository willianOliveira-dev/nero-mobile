 ...
 */
import type { ListOrders200DataItemItemsItemProductOptionLabels } from './listOrders200DataItemItemsItemProductOptionLabels';

export type ListOrders200DataItemItemsItemProduct = {
  name: string;
  imageUrl: string;
  optionLabels?: ListOrders200DataItemItemsItemProductOptionLabels;
  [key: string]: unknown;
};
