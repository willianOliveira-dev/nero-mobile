 ...
 */
import type { CreateHomeSection201FilterJson } from './createHomeSection201FilterJson';
import type { CreateHomeSection201Type } from './createHomeSection201Type';

export type CreateHomeSection201 = {
  /** @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$ */
  id: string;
  slug: string;
  title: string;
  type: CreateHomeSection201Type;
  sortOrder: number;
  isActive: boolean;
  filterJson: CreateHomeSection201FilterJson;
  updatedAt: string;
};
