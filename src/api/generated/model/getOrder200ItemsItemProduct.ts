 ...
 */
import type { GetOrder200ItemsItemProductOptionLabels } from './getOrder200ItemsItemProductOptionLabels';

export type GetOrder200ItemsItemProduct = {
  name: string;
  imageUrl: string;
  optionLabels?: GetOrder200ItemsItemProductOptionLabels;
  [key: string]: unknown;
};
