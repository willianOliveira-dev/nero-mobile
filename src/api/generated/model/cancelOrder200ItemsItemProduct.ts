 ...
 */
import type { CancelOrder200ItemsItemProductOptionLabels } from './cancelOrder200ItemsItemProductOptionLabels';

export type CancelOrder200ItemsItemProduct = {
  name: string;
  imageUrl: string;
  optionLabels?: CancelOrder200ItemsItemProductOptionLabels;
  [key: string]: unknown;
};
