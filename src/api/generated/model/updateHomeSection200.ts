 ...
 */
import type { UpdateHomeSection200FilterJson } from './updateHomeSection200FilterJson';
import type { UpdateHomeSection200Type } from './updateHomeSection200Type';

export type UpdateHomeSection200 = {
  /** @pattern ^([0-9a-fA-F]{8}-[0-9a-fA-F]{4}-[1-8][0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$ */
  id: string;
  slug: string;
  title: string;
  type: UpdateHomeSection200Type;
  sortOrder: number;
  isActive: boolean;
  filterJson: UpdateHomeSection200FilterJson;
  updatedAt: string;
};
